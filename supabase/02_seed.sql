...
from (values
 ('usbc-usbc','MT-CC65-03','','3 ft',25,200, 6000, 999,1,'in_stock'),
 ('usbc-usbc','MT-CC65-06','','6 ft',25,200, 7680, 999,2,'in_stock'),
 ('usbc-usbc','MT-CC65-10','','10 ft',100,200, 8960, 999,3,'in_stock'),
 ('usbc-lightning','MT-CL-06','850025312042','6 ft',25,200, 7920,1299,1,'in_stock'),
 ('usba-usbc','MT-AC-03','','3 ft',25,200, 5760, 999,1,'in_stock'),
 ('usba-usbc','MT-AC-10','','10 ft',100,200, 8400, 999,2,'in_stock'),
 ('usba-lightning','MT-AL-03','','3 ft',25,200, 5900, 999,1,'in_stock'),
 ('usba-lightning','MT-AL-10','','10 ft',100,200, 8600,1499,2,'in_stock'),
 ('wall-20w','MT-W20','','Single',100,400, 6470,1299,1,'in_stock'),
 ('car-45w','MT-C45','850025312035','Single',600,600, 4270, 999,1,'in_stock'),
 ('powerbank-soccer','MT-PB-SOC','','Single',6,48,13200,3999,1,'in_stock'),
 ('buds-plus','MT-BUDS-P','','Single',6,48,12720,3999,1,'in_stock'),
 ('airbuds-a5','MT-A5','','Single',100,100,11360,3999,1,'in_stock'),
 ('headset-anc','MT-HS-ANC','','Single',100,100,12800,3999,1,'in_stock'),
 ('wired-35mm','MT-EAR-35','1500002200006','Single',100,300, 4960, 999,1,'in_stock'),
 ('wired-usbc','MT-EAR-UC','','Single',100,300, 7040,1299,1,'in_stock'),
 ('wired-lightning','MT-EAR-LT','703977746056','Single',100,300, 7360,1299,1,'in_stock'),
